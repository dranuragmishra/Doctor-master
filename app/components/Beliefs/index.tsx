  ...
  return (
    <div className="mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 my-16 mx-5 gap-5">
        ...
        <div className="bg-darkblue pt-12 px-10 sm:px-24 pb-10 rounded-3xl">
        ...
        <div className="bg-[#d6ffeb] pt-12 px-10 pb-10 sm:px-24 rounded-3xl">
          ...
          <h3 className="text-4xl sm:text-65xl font-bold text-black leading-snug sm:mb-20 mb-5 text-center sm:text-start">
            <span className="text-blue">New</span> to the Dr. Anurag Mishra's
            Clinic? 
          </h3>
