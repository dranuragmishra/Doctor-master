            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                ...
                <div className="mx-auto sm:mx-0">
                    ...
                    <div className="py-3 text-center lg:text-start">
                        ...
                        Compassionate Care <br /> For All Your  <br /> Stomach Needs . 
                        </h1>
                    </div>
                ...
                <div className='lg:-m-24 lg:pl-16 hidden lg:block'>
                    <Image src="/images/banner/bhaiya_photo.jpeg" alt="hero-image" className=" mx-36 rounded-full" width={500} height={200} />
                </div>
